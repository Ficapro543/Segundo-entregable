...
Según \citep[pag. 1]{nikolaev2021librettos}, LibrettOS es un diseño de sistema operativo que emplea 2 paradigmas para abordar al mismo tiempo el aislamiento, rendimiento, compatibilidad, recuperación y actualizaciones en tiempo de ejecución, también actúa como un sistema de biblioteca para un mejor rendimiento, acceso a aplicaciones como el almacenamiento y redes.
La ventaja es que ambos paradigmas coinciden en el mismo sistema operativo que permite logra el objetivo de mayor flexibilidad, mejor optimización en el rendimiento, investigación como desarrollo y compatibilidad con aplicaciones POSIX.
