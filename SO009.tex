...
Este sistema operativo tiene varios objetivos, dentro de las claves se encuentran:
\begin{itemize}
    \item \textbf{Facil de usar y sencillez:} Según \citep{haiku_website_2025} El desarrollo de HaikuOS inspirado en BeOS, fue diseñado para la informática personal, HaikuOS es rápido, fácil de aprender y muy potente. Accesible por cualquier usuario que tenga a su alcance.
