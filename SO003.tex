...
Recuperación ante fallos / actua-lización en caliente & \texttt{loader}, \texttt{spawn} crates & Reemplaza módulos activos sin reiniciar el sistema completo. \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{Sistema de carga dinámica y enlazado en tiempo de ejecución:} Theseus modifica el compilador (\texttt{rustc}) y el \textit{linker} para permitir la carga y sustitución de (\textit{cells}) en ejecución \citep{boos2017theseus}.
    \item \textbf{Emuladores y máquinas virtuales:} Se utilizan entornos como \textbf{QEMU} para probar, depurar y validar el funcionamiento del sistema \citep{theseus_GitHub}.
