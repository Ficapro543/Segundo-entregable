...
\begin{table}[H]
\centering
\caption{Tabla comparativa resumida de sistemas operativos educativos y experimentales}
\label{tab:so-resumida}
\begin{tabular}{|p{2.3cm}|p{2.7cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|p{2.3cm}|}
\hline
\textbf{S.O.} & \textbf{Arquitectura} & \textbf{Lenguaje} & \textbf{Documentación} & \textbf{Comunidad} & \textbf{Dificultad} \\ \hline
