...
Educativo, experimental, comercial
\begin{itemize}
    \item FreeRTOS es un sistema operativo de tiempo real (RTOS) para sistemas embebidos, concebido para ser muy liviano y portable. Está licenciado bajo MIT (código abierto).
    \item Su objetivo es proveer un kernel RTOS completo (planificador, comunicación entre tareas, temporizadores, etc.) para microcontroladores y pequeños procesadores.
    \item Es usado tanto en entornos industriales/hobby como en educación (se emplea como ejemplo real en cursos de sistemas embebidos).
\end{itemize} 
